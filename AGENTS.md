...
- The private `/list` page is for internal price review, hides normal site header/footer, stays visually light-mode, uses browser-stored editable prices/version snapshots, and is protected by the hardcoded session password `tina`.
