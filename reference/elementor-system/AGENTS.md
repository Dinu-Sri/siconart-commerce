...
## 2026-06-28 Sicon Art Next.js Migration Notice

This folder is currently being reviewed as source/reference material for migrating `siconart.com` from WordPress/WooCommerce/Elementor to a fresh Next.js storefront for VPS deployment. Do not move, delete, or overwrite the existing Elementor system until the migration plan is approved. The current UX/UI approval plan is in `docs/siconart-nextjs-ux-ui-plan.md`, and the proposed replacement agent guide is in `docs/siconart-nextjs-agents-structure.md`.
...
**How to update:** Edit this AGENTS.md file directly. Add new entries to the relevant section. If no section fits, create a new one (e.g., "## Known Issues", "## Advanced Patterns"). Include the date of the change.
...
**Step 7 — Update the changelog in AGENTS.md:**
...
4. **Update your knowledge.** Edit this AGENTS.md file with the correct property names/patterns so the fix is permanent.
...
> This section tracks when AGENTS.md itself was updated with new knowledge.
...
| 2026-02-15 | Added GitHub sync workflow to AGENTS.md | Full step-by-step process for syncing project learnings to the universal repo. Added README update as mandatory step. Updated README.md with v1.2.0 features, full command reference, changelog, and universal vision |
...
4. Start an AI chat and say: `@workspace Read AGENTS.md first`

### When AI Discovers Improvements

During any session, if the AI fixes a bug, discovers a new pattern, or learns something:
1. AI updates `AGENTS.md` (and `docs/design-system.json` if relevant)
...
|----------------------|-----------------|
| `AGENTS.md` | `ai-elementor-template/AGENTS.md` |
...
Copy-Item "AGENTS.md" -Destination "ai-elementor-template/AGENTS.md" -Force
...
- `AGENTS.md` — AI knowledge base (updated by AI)
