...
export type Product = {
  ...
  priceCents: number;
  currency: "USD";
  /** Fallback image list. Shop and product pages also load `public/products/<slug>/feature.*` plus `gallery/`. */
  images: string[];
  uses: ProductUse[];
...
export const products: Product[] = [
  {
    ...
    priceCents: 1200,
    currency: "USD",
    images: ["/products/chi-ling-travel-brush/feature.jpg"],
  ...
  },
  {
    ...
    priceCents: 1300,
    currency: "USD",
    images: ["/products/ruyue-short-brush/feature.jpg"],
  ...
  },
  {
    ...
    priceCents: 1300,
    currency: "USD",
    images: ["/products/travel-series-brush-t3/feature.jpg"],
    uses: ["travel", "sketching", "line-and-wash"],
    handle: "travel",
    feel: "balanced",
    level: "beginner",
  ...
  },
  {
    ...
    priceCents: 2300,
    currency: "USD",
    images: ["/products/dark-green-short-wood-brush/feature.jpg"],
    uses: ["sketching", "detail", "wash"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1350,
    currency: "USD",
    images: ["/products/feng-short-sketch-brush/feature.jpg"],
  ...
  },
  {
    ...
    priceCents: 1350,
    currency: "USD",
    images: ["/products/happiness-short-travel-brush/feature.jpg"],
    uses: ["travel", "sketching", "line-and-wash"],
    handle: "travel",
    feel: "balanced",
    level: "beginner",
  ...
  },
  {
    ...
    priceCents: 1400,
    currency: "USD",
    images: ["/products/red-tiny-brush/feature.jpg"],
  ...
  },
  {
    ...
    priceCents: 2300,
    currency: "USD",
    images: ["/products/sicon-art-travel-brush-t7/feature.jpg"],
    uses: ["travel", "sketching", "line-and-wash"],
    handle: "travel",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 2300,
    currency: "USD",
    images: ["/products/sicon-art-travel-brush-t8/feature.jpg"],
    uses: ["travel", "sketching", "line-and-wash"],
    handle: "travel",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 2300,
    currency: "USD",
    images: ["/products/sicon-art-travel-brush-t9/feature.jpg"],
    uses: ["travel", "sketching", "line-and-wash"],
    handle: "travel",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 3900,
    currency: "USD",
    images: ["/products/t1-soulmate-limited-travel-brush/feature.jpg"],
    uses: ["travel", "sketching", "line-and-wash"],
    handle: "travel",
    feel: "balanced",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 1500,
    currency: "USD",
    images: ["/products/t10-travel-brush-ember/feature.jpg"],
    uses: ["travel", "sketching", "line-and-wash"],
    handle: "travel",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1400,
    currency: "USD",
    images: ["/products/t10-travel-brush-still/feature.jpg"],
    uses: ["travel", "sketching", "line-and-wash"],
    handle: "travel",
    feel: "balanced",
    level: "beginner",
  ...
  },
  {
    ...
    priceCents: 1500,
    currency: "USD",
    images: ["/products/chi-xiao-qingming-brush-a/feature.jpg"],
  ...
  },
  {
    ...
    priceCents: 1500,
    currency: "USD",
    images: ["/products/chi-xiao-qingming-brush-b/feature.jpg"],
    uses: ["wash", "line-and-wash", "studio"],
    handle: "short",
    feel: "soft",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1700,
    currency: "USD",
    images: ["/products/run-hao-short-brush/feature.jpg"],
    uses: ["sketching", "detail", "wash"],
    handle: "short",
    feel: "soft",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1950,
    currency: "USD",
    images: ["/products/early-spring-brush/feature.jpg"],
    uses: ["wash", "line-and-wash", "studio"],
    handle: "short",
    feel: "springy",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1900,
    currency: "USD",
    images: ["/products/spring-back-brush/feature.jpg"],
    uses: ["wash", "line-and-wash", "studio"],
    handle: "short",
    feel: "springy",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1900,
    currency: "USD",
    images: ["/products/green-sprig-spring-brush/feature.jpg"],
    uses: ["wash", "line-and-wash", "studio"],
    handle: "short",
    feel: "springy",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1500,
    currency: "USD",
    images: ["/products/purple-dream-brush/feature.jpg"],
    uses: ["wash", "line-and-wash", "studio"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1300,
    currency: "USD",
    images: ["/products/qing-yao-detail-brush/feature.jpg"],
    uses: ["detail", "line-and-wash"],
    handle: "short",
    feel: "soft",
    level: "beginner",
  ...
  },
  {
    ...
    priceCents: 1400,
    currency: "USD",
    images: ["/products/shede-short-brush/feature.jpg"],
    uses: ["sketching", "detail", "wash"],
    handle: "short",
    feel: "balanced",
    level: "beginner",
  ...
  },
  {
    ...
    priceCents: 1500,
    currency: "USD",
    images: ["/products/sicon-art-qin-brush/feature.jpg"],
    uses: ["wash", "line-and-wash", "studio"],
    handle: "short",
    feel: "soft",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 1950,
    currency: "USD",
    images: ["/products/zi-tan-brush/feature.jpg"],
    uses: ["wash", "line-and-wash", "studio"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 4200,
    currency: "USD",
    images: ["/products/deep-glow-brush/feature.jpg"],
    uses: ["wash", "studio", "detail"],
    handle: "long",
    feel: "soft",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 2400,
    currency: "USD",
    images: ["/products/raging-tide-bear-hair-wild-cursive-brush/feature.jpg"],
    uses: ["wash", "studio", "detail"],
    handle: "long",
    feel: "balanced",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 2300,
    currency: "USD",
    images: ["/products/short-handle-series-s1/feature.jpg"],
    uses: ["sketching", "detail", "wash"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 2400,
    currency: "USD",
    images: ["/products/snow-shadow-brush/feature.jpg"],
    uses: ["wash", "line-and-wash", "studio"],
    handle: "short",
    feel: "soft",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 5900,
    currency: "USD",
    images: ["/products/tai-chi-group-brush-yin-yang-pair-set/feature.jpg"],
    uses: ["wash", "studio", "detail"],
    handle: "long",
    feel: "balanced",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 3800,
    currency: "USD",
    images: ["/products/yun-tao-large-heavy-brush/feature.jpg"],
    uses: ["wash", "studio", "detail"],
    handle: "long",
    feel: "soft",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 6500,
    currency: "USD",
    images: ["/products/golden-bamboo-song/feature.jpg"],
    uses: ["wash", "studio", "detail"],
    handle: "long",
    feel: "soft",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 10500,
    currency: "USD",
    images: ["/products/song-elegance-golden-umbrella-brush/feature.jpg"],
    uses: ["wash", "studio", "detail"],
    handle: "long",
    feel: "soft",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 12200,
    currency: "USD",
    images: ["/products/song-mist-azure-lacquer/feature.jpg"],
    uses: ["wash", "studio", "detail"],
    handle: "long",
    feel: "soft",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 12200,
    currency: "USD",
    images: ["/products/xiang-bamboo-ebony-shadow-song-brush/feature.jpg"],
    uses: ["wash", "studio", "detail"],
    handle: "long",
    feel: "soft",
    level: "professional",
  ...
  },
  {
    ...
    priceCents: 2400,
    currency: "USD",
    images: ["/products/reusable-calligraphy-water-writing-scroll/feature.jpg"],
    uses: ["studio"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 2400,
    currency: "USD",
    images: ["/products/bamboo-and-linen-brush-roll-10-brush-holder/feature.jpg"],
    uses: ["studio"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 0,
    currency: "USD",
    images: ["/products/color-ring-bamboo-brush/feature.jpg"],
  ...
  },
  {
    ...
    priceCents: 0,
    currency: "USD",
    images: ["/products/jade-orb-dark-tip-brush/feature.png"],
  ...
  },
  {
    ...
    priceCents: 0,
    currency: "USD",
    images: ["/products/pink-youth-glow-brush/feature.png"],
    uses: ["sketching", "detail", "studio"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 0,
    currency: "USD",
    images: ["/products/sapphire-jade-brush/feature.png"],
  ...
  },
  {
    ...
    priceCents: 0,
    currency: "USD",
    images: ["/products/skyward-dragon-brush/feature.jpg"],
    uses: ["sketching", "wash", "studio"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
  ...
  },
  {
    ...
    priceCents: 0,
    currency: "USD",
    images: ["/products/turquoise-wave-brush/feature.png"],
    uses: ["sketching", "wash", "studio"],
    handle: "short",
    feel: "balanced",
    level: "enthusiast",
...
function catalogIndex(sku: string) {
  return products.findIndex((product) => product.sku === sku);
}

function addedRank(product: Product) {
  return product.addedAt || `2026-06-28-${String(catalogIndex(product.sku)).padStart(3, "0")}`;
}

export function getHomepageFeatured(limit = 12) {
  const featured = products.filter((product) => product.featured);
  const extra = products.filter((product) => !product.featured && isPurchasable(product));
  return [...featured, ...extra].slice(0, limit);
}

export function getNewArrivals(limit = 8) {
  const used = new Set(getHomepageFeatured(12).map((product) => product.sku));
  return products
    .filter((product) => isPurchasable(product) && !used.has(product.sku))
    .sort((left, right) => addedRank(right).localeCompare(addedRank(left)))
    .slice(0, limit);
}
